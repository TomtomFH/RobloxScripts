...
local function updateRewardLabels()
    ...
    if rewardStatsLabel then
        rewardStatsLabel.Text = string.format(
            "Rewards: %d Gold Blocks <font color=\"#63D471\">(+%d)</font> | %d Gold <font color=\"#63D471\">(+%d)</font>",
            goldBlocks,
            sessionGoldBlocks,
            gold,
            sessionGold
...
rewardStatsLabel = select(1, CreateValueLabel("Autofarm", "Rewards: 0 Gold Blocks <font color=\"#63D471\">(+0)</font> | 0 Gold <font color=\"#63D471\">(+0)</font>"))
bindPlayerData()
updateRewardLabels()
startRuntimeUpdater()
