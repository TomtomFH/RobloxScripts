...
local nurseryTypeNurseryEnabled = false  -- Include standard Nursery type
local nurseryTypeLegendaryEnabled = false  -- Include Legendary Nursery type
local nurseryTypeCosmicEnabled = false  -- Include Cosmic Nursery type
